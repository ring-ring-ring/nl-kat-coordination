...
De ontwikkelaars bij het Ministerie van VWS richten zich in eerste instantie op de rough edges en het verder compleet maken van OpenKAT. Daar horen ook packaging, deployment en verdere documentatie van het systeem bij. 

Voor de verdere toekomst denken we aan de volgende features en doorontwikkeling: 

* Boefjes uitbreiden
* KAT-alogus apart aanbieden
* Scheiding van boefjes en normalizers, sandboxed maken
* Rapportage engine flexibeler maken
* Communicatie engine afmaken (staat op laag pitje)

Bijdragen zijn welkom, neem vooral contact op via meedoen@openkat.nl of stuur je PR in via Github.
